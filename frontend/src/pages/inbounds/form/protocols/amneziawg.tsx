...
// The inbound form is Ant Design's controlled Form, not the RHF form used by
// a few newer screens. Keep this tiny adapter local so the protocol fields use
// the same name/valueProp semantics without introducing a second form state.
function FormField({ name, label, extra, valueProp, noStyle, children }: FormFieldProps) {
  return (
    <Form.Item
      name={name}
      label={label}
