...
export default function LoginPage() {
  ...
  const onSubmit = useCallback(async (values: LoginForm) => {
    ...
    try {
      ...
      // Reseller (نمایندگی) accounts land on their own sales report, the admin
      // on the panel overview.
      let target = 'panel/';
      const me = await HttpUtil.get<{ role?: string }>('/panel/api/auth/me', undefined, { silent: true });
      if (me?.success && me.obj?.role === 'reseller') target = 'panel/reseller/report';
