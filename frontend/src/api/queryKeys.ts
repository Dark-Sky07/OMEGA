export const keys = {
  ...
  resellers: {
    ...
    list: () => ['resellers', 'list'] as const,
    assignments: () => ['resellers', 'assignments'] as const,
    report: (id: number) => ['resellers', 'report', id] as const,
    selfReport: () => ['resellers', 'selfReport'] as const,
  },
  server: {
