...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/Dark-Sky07/OMEGA/v3.3.23-omega/install-omega.sh) v3.3.23-omega${plain}"
    echo ""
...
show_menu() {
    echo -e "
╔────────────────────────────────────────────────╗
│   ${green}OMEGA Panel Management Script${plain}                │
